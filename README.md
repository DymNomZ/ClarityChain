...
ClarityChain is a transparent donation platform built on Polkadot Hub where organizations and individuals can create campaigns and receive funds with one critical constraint in that **they can only send those funds by to whitelisted vendors.**
...
5. Submit withdrawals to the associated vendors' addresses
...
**The Public Feed (for everyone):** Human-readable event log showing campaigns created, donations received, vendor proposals submitted, validator approvals signed, and withdrawals sent. No wallet required to view.
...
Get free testnet PAS from the faucet: https://faucet.polkadot.io
...
Then open ```dapp/app/utils/contract.ts```
...
**Bottom line:**
>All trust credible issues are off-chain problems and are not ClarityChain's main selling point. Paper trail, transparency, and traceability ARE. ClarityChain solves a financial and spending problem not an identity and trust problem.

**Q: How is ClarityChain different from Giveth or The Giving Block?**
